...
if (game_data.locale == "ar_AE") {
    ...
    langShinko = [
        "ط§ظ„ط§ط؛ط§ط±ط§طھ",
        "ط§ط®طھط§ط± ط§ظ„ظˆط­ط¯ط§طھ ط§ظ„ظ…ط³طھط®ط¯ظ…ط© ظپظ‰ ط§ظ„ط§ط؛ط§ط±ط§طھ",
        "ط§ط®طھط§ط± ط§ظ†ظˆط§ط¹   ط§ظ„ط§ط؛ط§ط±ط§طھ ط§ظ„ظ…ط³طھط®ط¯ظ…ط© ",
        " ظ…ط§ ط§ظ„ظ…ط¯ظ‡ ط§ظ„ظ…ط¯ظ‡ ط§ظ„ط²ظ…ظ†ظٹظ‡ ط§ظ„ظ…ط±ط§ط¯ ط§ط±ط³ط§ظ„ ط§ظ„ط§ط؛ط§ط±ط§طھ ط¨ظ‡ط§",
        "ط¶ط¹ ط§ط§ظ„ظ…ط¯ظ‡ ظ‡ظ†ط§",
        "ط­ط³ط§ط¨ ط§ظ„ظ…ط¯ظ‡ ظ„ظƒظ„ طµظپط­ظ‡ ",
        "Creator: ",
        "ط§ظ„ط§ط؛ط§ط±ط§طھ : طھط±ط³ظ„ ظ„ظƒظ„ 50 ظ‚ط±ظٹظ‡ ط¹ظ„ظ‰ ط­ط¯ظ‰ ",
...
if (game_data.locale == "el_GR") {
    //greek server
    langShinko = [
        "خœخ±خ¶خ¹خ؛خ® دƒخ¬دپد‰دƒخ·",
        "خ•د€خ¹خ»خ­خ¾د„خµ د„خ¹د‚ خ¼خ؟خ½خ¬خ´خµد‚ خ¼خµ د„خ¹د‚ خ؟د€خ؟خ¯خµد‚ خ¸خ± خ؛خ¬خ½خµد„خµ دƒخ¬دپد‰دƒخ·",
        "خ•د€خ¹خ»خ­خ¾د„خµ خµد€خ¯د€خµخ´خ± دƒخ¬دپد‰دƒخ·د‚ د€خ؟د… خ¸خ± د‡دپخ·دƒخ¹خ¼خ؟د€خ؟خ¹خ·خ¸خ؟دچخ½",
        "خ§دپدŒخ½خ؟د‚ خ£خ¬دپد‰دƒخ·د‚ (خڈدپخµد‚.خ›خµد€د„خ¬)",
        "خ§دپدŒخ½خ؟د‚",
        "خ¥د€خ؟خ»دŒخ³خ¹دƒخµ د‡دپدŒخ½خ؟د…د‚ دƒخ¬دپد‰دƒخ·د‚ خ³خ¹خ± خ؛خ¬خ¸خµ دƒخµخ»خ¯خ´خ±.",
        "خ”خ·خ¼خ¹خ؟د…دپخ³دŒد‚: ",
        "خœخ±خ¶خ¹خ؛خ® دƒخ¬دپد‰دƒخ·: خ‘د€خ؟دƒد„خ؟خ»خ® خ±خ½خ± 50 د‡د‰دپخ¹خ¬",
        "خ‘د€خ؟دƒد„خ؟خ»خ® خ؟خ¼خ¬خ´خ±د‚ "
    ]
}
if (game_data.locale == "nl_NL") {
    ...
    langShinko = [
        ...
        "Kies categorieأ«n die je wil gebruiken",
...
if (game_data.locale == "it_IT") {
    ...
    langShinko = [
        ...
        "Seleziona i tipi da unitأ  con cui rovistare",
...
<button class="btn" id ="cog" onclick="settings()">âڑ™ï¸ڈ</button>
